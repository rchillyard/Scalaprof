...
case class Number[A : Numeric](s: String)(implicit conv: String=>Try[A]) extends Valuable[A] with Function0[Try[A]] {
  def apply = conv(s)
...
case class Constant[A : Numeric](s: String)(implicit lookup: String=>Option[A]) extends Valuable[A] {
